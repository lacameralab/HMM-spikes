% This file is a demo for applying Poisson HMM with Dirichlet prior (DPHMM) to spiking data.
% 
% NOTICE:
...
%% ========================     Poisson-HMM     ===========================
theta = 0.9; [estlambda,estGamma,isconverge,delta1,logliks,rec,iter,crit] = phmm_EM_Dirichlet(spkc(train_ind),m,lambda_guess,Gamma_guess,theta);
