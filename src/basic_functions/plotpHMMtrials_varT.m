function [ah] = plotpHMMtrials_varT(spkc,lambda,Gamma,startTs,endTs,dt,varargin)
% [ah] = plotpHMMtrials_varT(spkc,lambda,Gamma,startTs,endTs,dt,varargin)
% This function plots the decoding of all trials with various duration in
% the same plot.
% Inputs:
...
%   startTs: vector, the starting time of each trial
%   endTs: vector, the ending time of each trial
%   dt: HMM time bin size
%   varargin:
